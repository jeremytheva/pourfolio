    ...
    <div>
      ...
      <section className="mt-8 rounded-2xl border border-gray-200 bg-gray-50 p-5" aria-labelledby="add-bonus-attribute-heading">
        ...
        <div className="mt-3 flex items-center justify-between gap-3">
          <span className="text-sm text-gray-600">Category: <strong>Overall</strong></span>
          <button type="button" onClick={submitNewAttribute} disabled={creating} className="rounded-lg bg-amber-700 px-4 py-2 font-semibold text-white disabled:bg-gray-400">{creating ? 'Adding…' : 'Add attribute'}</button>
        </div>
      </section>
    </div>
  )
