...
test('connected provider workflows keep production provider configuration owned by the deployed runtime', () => {
  ...
  assert.ok(releaseWorkflow.includes('https://brew-buds-mobile-app-design-3577.vercel.app'))
  assert.ok(releaseWorkflow.includes("RELEASE_BASE_URL: ${{ github.event_name == 'issue_comment' && 'https://brew-buds-mobile-app-design-3577.vercel.app' || inputs.release_url }}"))
