...
- ADR 0003 defines the current deduction-game interaction and scoring model.
...
- [Current gameplay decision — ADR 0003](0003-adopt-brew-done-it-deduction-board.md)
