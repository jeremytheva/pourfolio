# ADR 0003: Adopt Brew Done It deduction-board gameplay
...
The UI presents this workspace as two accessible sides/tabs: **Brewery** and **Beer / Style**. Catalogue-backed deductions narrow candidate counts. Traits without certified structured source data may be recorded as notes but must not automatically eliminate candidates.
...
- brewery name and certified location fields;
- beer name, style/category, ABV, IBU, collaboration and edition; and
- supported clue traits.

This selector-only projection must never be returned to the active guesser.
